        ...
        <main>
            <div id="about-section" className="main-section">
                ...
                <div className="border-left-gradient"> 
                    ...
                    <p>Feel free to contact me at <a> vasiltopalovic@outlook.com</a>.</p>
                </div>
            ...
            <div id="projects-section" class="main-section">
                ...
                <div className="border-left-gradient"> 
                <ul>
                    <li><a href="https://github.com/vasiltop/post-board"> Post Board </a></li>
                    <li><a href="https://github.com/vasiltop/pathfinding-visualizer"> Pathfinding Visualizer </a></li>
                    <li><a href="https://github.com/vasiltop/raycasting-engine"> Raycasting Engine </a></li>
                    <li><a href="https://github.com/vasiltop/personal-website"> Personal Website </a></li>
                </ul>
                </div>
            </div>
